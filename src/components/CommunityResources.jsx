  ...
  return (
    <section className="max-w-7xl mx-auto mt-8 mb-8">
      <div className="rounded-2xl surface-panel p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-theme-muted text-center">Useful links and starting points to turn ideas into testable experiments.</p>
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center gap-3 text-center">
                  ...
                  <div>
                    <div className="font-medium text-theme">{c.title}</div>
                    <div className="text-sm text-theme-muted">{c.hint}</div>
                  </div>
                </div>
              </Link>
            );
